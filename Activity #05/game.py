...
def main_menu():
    ...
    while True:
        ...
        pygame.draw.rect(screen, COLOR_PURPLE, menu_button_play)
        pygame.draw.rect(screen, COLOR_PURPLE, menu_button_credits)
        pygame.draw.rect(screen, COLOR_PURPLE, menu_button_quit)
        ...
        screen.blit(txt_screen_play, (590, 328))
        screen.blit(txt_screen_credits, (560, 388))
        screen.blit(txt_screen_quit, (590, 448))
...
def game_pause():
    ...
    while pause:
        ...
        pygame.draw.rect(screen, COLOR_PURPLE, menu_button_resume)
        pygame.draw.rect(screen, COLOR_PURPLE, menu_button_restart)
        pygame.draw.rect(screen, COLOR_PURPLE, menu_button_menu)
        ...
        screen.blit(txt_screen_resume, (570, 328))
        screen.blit(txt_screen_restart, (563, 388))
        screen.blit(txt_screen_menu, (585, 448))
        pygame.display.update()
...
def credits_game():
    ...
    while True:
        ...
        pygame.draw.rect(screen, COLOR_PURPLE, button_menu)
        txt_screen_back = font.render("MENU", True, COLOR_BLACK)

        screen.blit(txt_screen_back, (size[0] / 2 - 560, size[1] / 2 - 343))
